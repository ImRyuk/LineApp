...
class AffluenceBloc extends Bloc<AffluenceEvent, AffluenceState> {
  ...
  AffluenceBloc({required this.api, required this.shopProvider})
      : super(AffluenceUninitialized());
  ...
  Stream<AffluenceState> _mapAffluenceStartToState(
    ...
    yield AffluenceLoaded(
        results, (results['$hour']['averageWait'].toString() + "min"));
  }
}
